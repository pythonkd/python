...
class Knight(Warrior):
    def __init__(self, attack=7, health=50, defense=0, vampirism=0):
...
class Defender(Warrior):
    def __init__(self, health=60, attack=3, defense=2, vampirism=0):
        super().__init__(health, attack, defense, vampirism)


class Vampire(Warrior):
    def __init__(self, health=40, attack=4, defense=0, vampirism=0.5):
        super().__init__(health, attack, defense, vampirism)
        ...
        while army_1.s[-1].health > 0:
            while True:
                if army_1.s[self.i].attack < army_2.s[self.j].defense:
                    ...
                    army_1.s[self.i].health += (army_1.s[self.i].attack - army_2.s[self.j].defense) * army_1.s[
                        self.i].vampirism
                ...
                if army_2.s[self.j].attack < army_1.s[self.i].defense:
                    ...
                    army_2.s[self.j].health += (army_2.s[self.j].attack - army_1.s[self.i].defense) * army_2.s[
                        self.j].vampirism
